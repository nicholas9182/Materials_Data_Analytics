...
from Materials_Data_Analytics.experiment_modelling.Xray_diffraction import GIWAXSMeasurementPixelImage, GIWAXSPattern
...
class TestCalibration(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        # self.assertEqual(self.my_calibration.detector, 'Eiger1M')
...
class TestGIWAXSMeasurementPixelImage(unittest.TestCase):
    ''' Test the GIWAXS class '''
    data_SLAC_BL113 = GIWAXSMeasurementPixelImage.from_SLAC_BL11_3(tif_filepaths= ['./test_trajectories/diffraction/GIWAXS_image_SLAC_1.tif',
    ...
    def test_transform(self):
        ...
        self.data_SLAC_BL113.transform(calibrator = ai,
                                    ...
                                    unit = 'A')
        self.assertTrue(type(self.data_SLAC_BL113 == GIWAXSMeasurementPixelImage))
...
class TestGIWAXSPattern(unittest.TestCase):
    ...
    data_SLAC_BL113 = (GIWAXSMeasurementPixelImage
                       .from_SLAC_BL11_3(tif_filepaths= ['./test_trajectories/diffraction/GIWAXS_image_SLAC_1.tif',
                                                         './test_trajectories/diffraction/GIWAXS_image_SLAC_2.tif'])
    ...
    def test_extract_profile(self):
        ...
        profile_df = self.data_SLAC_BL113.extract_profile(chi_min = 20,
                                                          chi_max = 40,
                                                          q_range = (0.2, 2))
    ...
    def test_plot_profile(self):
        ...
        output = self.data_SLAC_BL113.plot_profile(chi_min = 20,
                                                   chi_max = 40,
                                                   q_range = (0.2, 2))
