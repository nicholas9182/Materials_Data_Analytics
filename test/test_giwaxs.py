...
class TestGIWAXSPattern(unittest.TestCase):
    ...
    def test_plot_map_reciprocal_space_image_hv(self):
        ''' Test the plot_map_reciprocal_space_hv method of the GIWAXSPattern class '''
        figure = self.data_SLAC_BL113.plot_reciprocal_map_hv()
        # figure.show()
    ...
    def test_plot_map_polar_space_image_hv(self):
        ''' Test the plot_map_reciprocal_space_hv method of the GIWAXSPattern class '''
        figure = self.data_SLAC_BL113.plot_polar_map_hv()
        # figure.show()
        self.assertTrue(type(figure) == hv.Image)                               
