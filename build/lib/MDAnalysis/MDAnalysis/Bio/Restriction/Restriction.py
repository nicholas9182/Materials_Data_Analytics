...
class FormattedSeq:
    """A linear or circular sequence object for restriction analytics.
...
class Analysis(RestrictionBatch, PrintFormat):
    """Provide methods for enhanced analytics and pretty printing."""
    ...
    def __init__(
        ...
        If no dictionary is given a new analytics using the RestrictionBatch
    ...
    def print_that(self, dct=None, title="", s1=""):
        """Print the output of the analytics.
    ...
    def full(self, linear=True):
        """Perform analytics with all enzymes of batch and return all results.
