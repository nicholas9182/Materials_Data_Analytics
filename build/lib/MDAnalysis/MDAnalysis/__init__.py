...
"""
:mod:`MDAnalysis` --- analytics of molecular simulations in python
=================================================================
...
relatively fast framework for complex analytics tasks. In addition,
...
separately, e.g. for RMS fitting ``import MDAnalysis.analytics.align``.)
...
due.cite(Doi("10.25080/majora-629e541a-00e"),
         description="Molecular simulation analytics library",
