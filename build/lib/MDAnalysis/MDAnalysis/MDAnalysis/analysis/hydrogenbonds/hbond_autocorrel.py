...
#
"""\
Hydrogen bond autocorrelation --- :mod:`MDAnalysis.analytics.hydrogenbonds.hbond_autocorrel`
===========================================================================================
...
.. versionchanged:: 2.0.0
   ...
   Module moved from :mod:`MDAnalysis.analytics.hbonds.hbond_autocorrel` to
   :mod:`MDAnalysis.analytics.hydrogenbonds.hbond_autocorrel`.
...
::
  ...
  from MDAnalysis.analytics import hbonds
...
counted as part of the analytics.  This could be used to exclude the
consideration of hydrogen bonds within the same functional group, or to perform
analytics on strictly intermolecular hydrogen bonding.
...
All results of the analytics are available through the *solution* attribute.
...
due.cite(Doi("10.1063/1.4922445"),
         ...
         path='MDAnalysis.analytics.hbonds.hbond_autocorrel',
)
del Doi
...
class HydrogenBondAutoCorrel(object):
    ...
    def __init__(self, universe,
        ...
        #warnings.warn("This class is deprecated, use analytics.hbonds.HydrogenBondAnalysis "
    ...
    def __repr__(self):
        return ("<MDAnalysis HydrogenBondAutoCorrel analytics measuring the "
