...
r"""Principal Component Analysis (PCA) --- :mod:`MDAnalysis.analytics.pca`
=====================================================================
...
First load all modules and test data::
    ...
    import MDAnalysis.analytics.pca as pca
...
class PCA(AnalysisBase):
    """Principal component analytics on an MD trajectory.
    ...
    variance will be available for analytics. As an example:::
    ...
    .. versionchanged:: 2.0.0
       ...
       are now stored in a :class:`MDAnalysis.analytics.base.Results` instance.
    """
    ...
    def rmsip(self, other, n_components=None):
        ...
        See also
        --------
        :func:`~MDAnalysis.analytics.pca.rmsip`
    ...
    def cumulative_overlap(self, other, i=0, n_components=None):
        ...
        See also
        --------
        :func:`~MDAnalysis.analytics.pca.cumulative_overlap`
