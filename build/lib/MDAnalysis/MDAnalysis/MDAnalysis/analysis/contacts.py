...
"""
Native contacts analytics --- :mod:`MDAnalysis.analytics.contacts`
================================================================
...
Examples for contact analytics
-----------------------------

One-dimensional contact analytics
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
in MDAnalysis. ::
    ...
    from MDAnalysis.analytics import contacts
    ...
    # set up analytics of native contacts ("salt bridges"); salt bridges have a
    # distance <6 A
    ca1 = contacts.Contacts(u, select=(sel_acidic, sel_basic),
                            refgroup=(acidic, basic), radius=6.0)
    # iterate through trajectory and perform analytics of "native contacts" Q
    ca1.run()
...
Two-dimensional contact analytics (q1-q2)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Writing your own contact analytics
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The :class:`Contacts` class has been designed to be extensible for your own
analytics. As an example we will analyze when the acidic and basic groups of AdK
...
:func:`is_any_closer` function as an argument to `method` and run the analytics::
...
logger = logging.getLogger("MDAnalysis.analytics.contacts")
...
def q1q2(u, select='all', radius=4.5):
    ...
    contacts : :class:`Contacts`
        Contact Analysis that is set up for a q1-q2 analytics
