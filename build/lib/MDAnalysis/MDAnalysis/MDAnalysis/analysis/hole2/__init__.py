...
"""HOLE Analysis --- :mod:`MDAnalysis.analytics.hole2`
=====================================================================================
...
the code below runs the `HOLE`_ program installed at '~/hole2/exe/hole' ::
    ...
    from MDAnalysis.analytics import hole2
...
The class can be set-up and run like a normal MDAnalysis analytics class::
...
after the analytics, you can call :meth:`~HoleAnalysis.delete_temporary_files`::
...
only show every other frame (step 2) then the HOLE analytics will be ::
...
.. [#create_vmd_surface_function] If you use the :class:`hole` class to run
              ...
              :func:`MDAnalysis.analytics.hole2.utils.create_vmd_surface`
...
due.cite(Doi("10.1016/S0006-3495(93)81293-1"),
         ...
         path="MDAnalysis.analytics.hole2",
         cite_module=True)
...
due.cite(Doi("10.1016/j.jmb.2013.10.024"),
         description="HOLE trajectory analytics with orderparameters",
         path="MDAnalysis.analytics.hole2",
         cite_module=True)
del Doi
