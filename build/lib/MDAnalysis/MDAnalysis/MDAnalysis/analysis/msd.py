...
r"""
Mean Squared Displacement --- :mod:`MDAnalysis.analytics.msd`
==============================================================
...
.. warning::
    To correctly compute the MSD using this analytics module, you must supply
...
.. code-block:: python
    ...
    import MDAnalysis.analytics.msd as msd
...
analytics by using the class :class:`EinsteinMSD`
...
class EinsteinMSD(AnalysisBase):
    ...
    n_frames : int
        Number of frames included in the analytics.
    n_particles : int
