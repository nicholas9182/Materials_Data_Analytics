...
"""Diffusion map --- :mod:`MDAnalysis.analytics.diffusionmap`
=====================================================================
...
.. code-block:: python
   ...
   import MDAnalysis.analytics.diffusionmap as diffusionmap
...
logger = logging.getLogger("MDAnalysis.analytics.diffusionmap")
...
class DistanceMatrix(AnalysisBase):
    ...
    :mod:`~MDAnalysis.analytics.diffusionmap` and can be passed
