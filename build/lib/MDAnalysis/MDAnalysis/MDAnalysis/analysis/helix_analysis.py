...
"""
HELANAL --- analytics of protein helices
=======================================
...
You can pass in a single selection::
    ...
    from MDAnalysis.analytics import helix_analysis as hel
...
The :func:`helix_analysis` function will carry out helix analytics on
...
class HELANAL(AnalysisBase):
    r"""
    Perform HELANAL helix analytics on your trajectory.
    ...
    select : str or iterable of str, optional
        ...
        analytics is applied to. Note that HELANAL is designed to work on the
