...
#
"""
dimensionality reduction frontend --- :mod:`MDAnalysis.analytics.encore.dimensionality_reduction.reduce_dimensionality`
======================================================================================================================
...
def reduce_dimensionality(ensembles,
    ...
    method : MDAnalysis.analysis.encore.dimensionality_reduction.DimensionalityReductionMethod or list
        ...
        classes from the dimensionality_reduction module. A separate analytics
    ...
    distance_matrix : encore.utils.TriangularMatrix, optional
        ...
        If several distance matrices are supplied, an analytics will be done
