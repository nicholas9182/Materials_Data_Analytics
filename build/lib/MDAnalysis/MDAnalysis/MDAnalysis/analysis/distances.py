...
"""
Distance analytics --- :mod:`MDAnalysis.analytics.distances`
==========================================================
...
import warnings
import logging
logger = logging.getLogger("MDAnalysis.analytics.distances")
...
def contact_matrix(coord, cutoff=15.0, returntype="numpy", box=None):
    ...
    See Also
    --------
    :mod:`MDAnalysis.analytics.contacts` for native contact analytics
