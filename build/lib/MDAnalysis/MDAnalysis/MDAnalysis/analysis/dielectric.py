...
r"""
Dielectric --- :mod:`MDAnalysis.analytics.dielectric`
===========================================================
...
due.cite(Doi("10.1080/00268978300102721"),
         description="Dielectric analytics",
         path="MDAnalysis.analytics.dielectric",
         cite_module=True)
del Doi
...
class DielectricConstant(AnalysisBase):
    ...
    atomgroup : MDAnalysis.core.groups.AtomGroup
      Atomgroup on which the analytics is executed
    temperature : float
    ...
    then use the :meth:`run` method::
      ...
      from MDAnalysis.analytics.dielectric import DielectricConstant
    ...
    within the :class:`~MDAnalysis.analytics.base.Results` attribute.
