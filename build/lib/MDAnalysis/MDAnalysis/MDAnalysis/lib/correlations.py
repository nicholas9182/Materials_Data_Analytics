...
This module is primarily for internal use by other analytics modules. It
...
.. seeAlso::
    ...
    Analysis tools that make use of modules:
        ...
        * :class:`MDAnalysis.analytics.waterdynamics.SurvivalProbability`
            Calculates the continuous or intermittent survival probability
            of an atom group in a region of interest.

        * :class:`MDAnalysis.analytics.hbonds.hbond_analysis`
