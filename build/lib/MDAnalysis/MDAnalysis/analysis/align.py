...
"""Coordinate fitting and alignment --- :mod:`MDAnalysis.analytics.align`
=====================================================================
...
examples execute first ::
   ...
   >>> from MDAnalysis.analytics import align
   >>> from MDAnalysis.analytics.rms import rmsd
...
.. versionchanged:: 0.10.0
   Function :func:`~MDAnalysis.analytics.rms.rmsd` was removed from
   this module and is now exclusively accessible as
   :func:`~MDAnalysis.analytics.rms.rmsd`.

.. versionchanged:: 0.16.0
   Function :func:`~MDAnalysis.analytics.align.rms_fit_trj` deprecated
   in favor of :class:`AlignTraj` class.

.. versionchanged:: 0.17.0
   removed deprecated :func:`~MDAnalysis.analytics.align.rms_fit_trj`
...
logger = logging.getLogger('MDAnalysis.analytics.align')
...
def rotation_matrix(a, b, weights=None):
    ...
    See Also
    --------
    MDAnalysis.analytics.rms.rmsd: Calculates the RMSD between *a* and *b*.
...
def alignto(mobile, reference, select=None, weights=None,
    ...
    select : str or dict or tuple (optional)
       ...
       2. a dictionary ``{'mobile': sel1, 'reference': sel2}`` where *sel1*
          ...
          :func:`MDAnalysis.analytics.align.fasta2select` function returns such
...
class AverageStructure(AnalysisBase):
    ...
    def __init__(self, mobile, reference=None, select='all', filename=None,
        ...
        .. versionchanged:: 2.0.0
           ...
           stored in a :class:`MDAnalysis.analytics.base.Results` instance.
        """
        if in_memory or isinstance(mobile.trajectory, MemoryReader):
            mobile.transfer_to_memory()
            filename = None
