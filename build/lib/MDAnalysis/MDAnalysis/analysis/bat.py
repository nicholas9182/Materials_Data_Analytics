...
#
r"""Bond-Angle-Torsion coordinates analytics --- :mod:`MDAnalysis.analytics.bat`
===========================================================================
...
See Also
--------
:class:`~MDAnalysis.analytics.dihedrals.Dihedral`
...
The :class:`~MDAnalysis.analytics.bat.BAT` class defines bond-angle-torsion
...
of adenylate kinase (AdK). The trajectory is included within the test data files::
   ...
   from MDAnalysis.analytics.bat import BAT
...
class BAT(AnalysisBase):
    ...
    @due.dcite(Doi("10.1002/jcc.26036"),
               ...
               path="MDAnalysis.analytics.bat.BAT")
