...
"""
=================================================================================
Ensemble Similarity Calculations --- :mod:`MDAnalysis.analytics.encore.similarity`
=================================================================================
...
examples first execute: ::
    ...
    >>> import MDAnalysis.analytics.encore as encore
...
:mod:`MDAnalysis.analytics.encore.dimensionality_reduction.reduce_dimensionality`.
...
def hes(ensembles,
    ...
    you can call use an :class:`~MDAnalysis.analytics.align.AlignTraj` object
    manually:
...
def ces(ensembles,
    ...
    clustering_method :
        ...
        :class:`MDAnalysis.analytics.encore.clustering.ClusteringMethod` classes
