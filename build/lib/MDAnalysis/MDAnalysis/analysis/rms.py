...
#
"""
Calculating root mean square quantities --- :mod:`MDAnalysis.analytics.rms`
==========================================================================
...
See Also
--------
:mod:`MDAnalysis.analytics.align`
...
:attr:`RMSD.results.rmsd` is plotted with :func:`matplotlib.pyplot.plot` (see Figure :ref:`RMSD plot figure <figure-RMSD>`)::
   ...
   import MDAnalysis.analytics.rms

   R = MDAnalysis.analytics.rms.RMSD(u, ref,
...
logger = logging.getLogger('MDAnalysis.analytics.rmsd')
...
class RMSD(AnalysisBase):
    r"""Class to perform RMSD analytics on a trajectory.
    ...
    Run the analytics with :meth:`RMSD.run`, which stores the results
...
class RMSF(AnalysisBase):
    ...
    Run the analytics with :meth:`RMSF.run`, which stores the results
    ...
    def __init__(self, atomgroup, **kwargs):
        ...
        :class:`MDAnalysis.analytics.align.AlignTraj`::
        ...
        the RMSF::
           ...
           from MDAnalysis.analytics.rms import RMSF
