...
"""
Generation and Analysis of X3DNA helicoidal parameter profiles --- :mod:`MDAnalysis.analytics.legacy.x3dna`
==========================================================================================================
...
.. versionchanged:: 0.16.0
   ...
   :mod:`MDAnalysis.analytics.legacy` package (see `issue 906`_)
...
B-DNA structure::
   ...
   from MDAnalysis.analytics.x3dna import X3DNA, X3DNAtraj
...
logger = logging.getLogger("MDAnalysis.analytics.x3dna")
...
class BaseX3DNA(object):
    """Baseclass for X3DNA_ analytics, providing plotting and utility functions.
...
class X3DNA(BaseX3DNA):
    ...
    def __init__(self, filename, **kwargs):
        ...
        logger.info("Setting up X3DNA analytics for %(filename)r", vars(self))
...
class X3DNAtraj(BaseX3DNA):
    ...
    def run(self, **kwargs):
        ...
        for ts in self.universe.trajectory[start:stop:step]:
            logger.info("X3DNA analytics frame %4d ", ts.frame)
