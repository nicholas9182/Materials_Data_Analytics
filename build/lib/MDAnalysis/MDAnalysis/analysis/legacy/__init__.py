...
""":mod:`MDAnalysis.analytics.legacy` --- Legacy analytics code
==========================================================

.. versionadded:: 0.16.0

The :mod:`MDAnalysis.analytics.legacy` package contains analytics
...
unique analytics capabilities and are therefore provided **as is**.
...
it explicitly. For example, ::
   ...
   from MDAnalysis.analytics.legacy import x3dna
