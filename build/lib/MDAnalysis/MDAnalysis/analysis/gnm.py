...
r"""
Elastic network analytics of MD trajectories --- :mod:`MDAnalysis.analytics.gnm`
==============================================================================
...
.. code-block:: python
    ...
    C = MDAnalysis.analytics.gnm.GNMAnalysis(u, ReportVector="output.txt")
...
directly needed to perform the analytics.
...
logger = logging.getLogger('MDAnalysis.analytics.GNM')
...
class GNMAnalysis(AnalysisBase):
    ...
    .. versionchanged:: 2.0.0
       Use :class:`~MDAnalysis.analytics.AnalysisBase` as parent class and
