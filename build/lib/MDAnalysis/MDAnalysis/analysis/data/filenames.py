...
:mod:`MDAnalysis.analytics.data` contains data files that are used as part of
analytics. These can be experimental or theoretical data. Files are stored
inside the package and made accessible via variables in 
:mod:`MDAnalysis.analytics.data.filenames`. These variables are documented
below, including references to the literature and where they are used inside
:mod:`MDAnalysis.analytics`.
...
.. data:: Rama_ref
   ...
   :class:`MDAnalysis.analytics.dihedrals.Ramachandran`.  The data were
   ...
   Load and plot it with ::
      ...
      from MDAnalysis.analytics.data.filenames import Rama_ref
...
.. data:: Janin_ref
   ...
   Reference Janin histogram for :class:`MDAnalysis.analytics.dihedrals.Janin`.
   ...
   Load and plot it with ::
      ...
      import numpy as np
      import matplotlib.pyplot as plt
      from MDAnalysis.analytics.data.filenames import Janin_ref
