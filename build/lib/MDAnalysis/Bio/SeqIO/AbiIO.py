...
_INSTRUMENT_SPECIFIC_TAGS["abi_3530/3530xl"] = {
    ...
    "AEPt1": "Analysis Ending scan number for basecalling on initial analytics",
    "AEPt2": "Analysis Ending scan number for basecalling on last analytics",
    "APCN1": "Amplicon name",
    ...
    "ASPt1": "Analysis Starting scan number for first analytics",
    "ASPt2": "Analysis Starting scan number for last analytics",
    ...
    "B1Pt1": "Reference scan number for mobility and spacing curves for first analytics",
    "B1Pt2": "Reference scan number for mobility and spacing curves for last analytics",
    "BCTS1": "Basecaller timestamp. Time of completion of most recent analytics",
    ...
    "PDMF2": "Mobility file name chosen in most recent analytics (identical to PDMF1)",
    ...
    "SPAC1": "Average peak spacing used in last analytics",
