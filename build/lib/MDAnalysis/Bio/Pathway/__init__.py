...
Bio.Pathway is a lightweight class library designed to support the following tasks:
 ...
 - Data interchange and preprocessing between pathway databases and analytics software.
 - Quick prototyping of pathway analytics algorithms
...
graph theoretic and numeric analytics.
