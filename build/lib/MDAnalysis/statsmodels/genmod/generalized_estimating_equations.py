...
References
----------
KY Liang and S Zeger. "Longitudinal data analytics using
...
%(family_doc)s
    ...
    weights : array_like
        An array of case weights to use in the analytics.
    %(extra_params)s
...
class GEE(GLM):
    ...
    def fit_regularized(self, pen_wt, scad_param=3.7, maxiter=100,
        ...
        scale : float or string
            ...
            analytics).  If None, the default approach for the family
        ...
        equations for high-dimensional longitudinal data analytics.
