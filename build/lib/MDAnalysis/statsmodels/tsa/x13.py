...
def x13_arima_analysis(
    ...
    """
    Perform x13-arima analytics for monthly or quarterly data.
    ...
    speconly : bool
        ...
        performing the analytics. Can be useful for debugging.
    start : str, datetime
...
def x13_arima_select_order(
    ...
    Bunch
        ...
        - results : str
          The full results from the X12/X13 analytics.
        - stdout : str
          The captured stdout from the X12/X13 analytics.
