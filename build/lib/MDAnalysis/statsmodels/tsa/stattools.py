"""
Statistical tools for time series analytics
"""
...
def acovf(x, adjusted=False, demean=True, fft=True, missing="none", nlag=None):
    ...
    References
    ----------
    .. [1] Parzen, E., 1963. On spectral analytics with missing observations
...
def pacf_ols(x, nlags=None, efficient=True, adjusted=False):
    ...
    .. [1] Box, G. E., Jenkins, G. M., Reinsel, G. C., & Ljung, G. M. (2015).
       Time series analytics: forecasting and control. John Wiley & Sons, p. 66
    """
    x = array_like(x, "x")
    nlags = int_like(nlags, "nlags", optional=True)
