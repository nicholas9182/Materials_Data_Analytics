...
class CorrelationEffects(RegressionEffects):
    ...
    constructing test statistics for a knockoff analytics, as
...
class OLSEffects(RegressionEffects):
    """
    OLS regression for knockoff analytics.
    ...
    approach to constructing test statistics for a knockoff analytics,
...
class RegModelEffects(RegressionEffects):
    """
    Use any regression model for Regression FDR analytics.
