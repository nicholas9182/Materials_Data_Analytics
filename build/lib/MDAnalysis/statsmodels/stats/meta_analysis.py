...
class CombineResults(object):
    ...
    def test_homogeneity(self):
        ...
        res : HolderTuple instance
            ...
            - statistic : float
                Test statistic, ``q`` in meta-analytics, this is the
...
def effectsize_smd(mean1, sd1, nobs1, mean2, sd2, nobs2):
    """effect sizes for mean difference for use in meta-analytics
...
def combine_effects(effect, variance, method_re="iterated", row_names=None,
    ...
    """combining effect sizes for effect sizes using meta-analytics
    ...
    for all residual variance. Traditional meta-analytics uses a fixed
