...
class SquareTable(Table):
    ...
    def summary(self, alpha=0.05, float_format="%.3f"):
        """
        Produce a summary of the analytics.
...
class Table2x2(SquareTable):
    ...
    Note that for the risk ratio, the analytics is not symmetric with
    ...
    def summary(self, alpha=0.05, float_format="%.3f", method="normal"):
        """
        Summarizes results for a 2x2 table analytics.
...
class StratifiedTable:
    ...
    def from_data(cls, var1, var2, strata, data):
        ...
        strata : int or string
            ...
            defining the strata.
        data : array_like
            The raw data.  A cross-table for analytics is constructed
