...
analytics. Psychological Methods 15:4, 309-334.
...
class Mediation:
    ...
    Examples
    --------
    A basic mediation analytics using formulas:
    ...
    A basic mediation analytics without formulas.  This may be slightly
    ...
    A moderated mediation analytics.  The mediation effect is computed
    ...
    package for causal mediation analytics.  Journal of Statistical
...
class MediationResults:
    """
    A class for holding the results of a mediation analytics.
    ...
    def summary(self, alpha=0.05):
        """
        Provide a summary of a mediation analytics.
        """
