...
def general_cosine(M, a, sym=True):
    ...
    sym : bool, optional
        ...
        design.
        When False, generates a periodic window, for use in spectral analytics.
...
def kaiser(M, beta, sym=True):
    ...
    References
    ----------
    .. [1] J. F. Kaiser, "Digital Filters" - Ch 7 in "Systems analytics by
    ...
    .. [3] Wikipedia, "Window function",
           https://en.wikipedia.org/wiki/Window_function
    .. [4] F. J. Harris, "On the use of windows for harmonic analytics with the
...
def chebwin(M, at, sym=True):
    ...
    .. [3] F. J. Harris, "On the use of windows for harmonic analytics with the
    ...
    """
    if np.abs(at) < 45:
        warnings.warn("This window is not suitable for spectral analytics "
...
def exponential(M, center=None, tau=1., sym=True):
    ...
    References
    ----------
    .. [1] S. Gade and H. Herlufsen, "Windows to FFT analytics (Part I)",
...
def dpss(M, NW, Kmax=None, sym=True, norm=None, return_ratios=False):
    ...
    .. [2] Slepian, D. Prolate spheroidal wave functions, Fourier analytics, and
