...
def lombscargle(x,
    ...
    References
    ----------
    .. [1] N.R. Lomb "Least-squares frequency analytics of unequally spaced
           data", Astrophysics and Space Science, vol 39, pp. 447-462, 1976

    .. [2] J.D. Scargle "Studies in astronomical time series analytics. II -
           Statistical aspects of spectral analytics of unevenly spaced data",
...
def check_COLA(window, nperseg, noverlap, tol=1e-10):
    ...
    "Periodic" or "DFT-even" Hann window (for FFT analytics) is COLA for
